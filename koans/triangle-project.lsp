...
(defun triangle (a b c)
  (cond
    ((some #'zerop (list a b c)) (make-condition 'triangle-error))
    ((some (lambda (x) (< x 0)) (list a b c)) (make-condition 'triangle-error))
    ((not (is-valid a b c)) (make-condition 'triangle-error))
    ((= a b c) :equilateral)
